...
public class DebuggingCommands {
    ...
    @Command(aliases = {"testbreak"}, usage = "[player]", desc = "模拟方块破坏", min = 1, max = 1, flags = "ts")
    ...
    @Command(aliases = {"testplace"}, usage = "[player]", desc = "模拟方块放置", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testinteract"}, usage = "[player]", desc = "模拟方块交互", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testdamage"}, usage = "[player]", desc = "模拟实体伤害", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
